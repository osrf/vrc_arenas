#!/usr/bin/env python
import roslib; roslib.load_manifest('eigenatlas')
...
g_grasps = { 'cyl': { 'origin':[0] * 12,
                      'grasp': [0,1.5,1.7, 0,1.5,1.7, 0,1.5,1.7, -0.2,.8,1.2]},
             'sph': { 'origin':[-0.7,0,0, 0.1,0,0, 0.7,0,0, 0,0,0],
                      'grasp': [0,1.4,1.4, 0,1.4,1.4, 0,1.4,1.4, 0,0.7,0.7]} }
...
if __name__ == '__main__':
  ...
  g_jc.kp_position = [4000, 4000, 14000, 20,  # back
                      ...
                      2000, 1000, 200, 200, 50, 100, # left arm
                      2000, 1000, 200, 200, 50, 100] # right arm
  g_jc.kd_position = [10.0, 10.0, 10.0, 1.0, # back
